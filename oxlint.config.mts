...
export default defineConfig({
  ...
  // Front-end sources use their renderer-specific ESLint configuration.
  // Matched from either end so the pattern holds whether oxlint runs from the
  // workspace root or from inside a package.
